			...
			<div class="col py-3">
				...
				<div class="container form-dang-nhap">
					<div class="modal-body">
						<form:form action="insertDotKhuyenMai.htm" modelAttribute="dotKhuyenMai1">
							...
							<div>
								...
								<div class="row">
									...
									<div class="col">
										<label for="recipient-name" class="col-form-label">Ngày
											kết thúc :</label> <form:input type="date" class="form-control"
											value="2023-01-01"
											path="tGKT" />
									</div>
									</div>
														...
														<div class="row">
															<div class="col">
																<label for="recipient-name" class="col-form-label">Ngày bắt đầu
																	:</label> <label for="recipient-name" class="col-form-label">
																	${dotkhuyenmai.tGBD}</label>
															</div>
														</div>
														<div class="row">
															<div class="col">
																<label for="recipient-name" class="col-form-label">Ngày kết thúc
																	:</label> <label for="recipient-name" class="col-form-label">
																	${dotkhuyenmai.tGKT}</label>
															</div>
														</div>
														<div class="row">
															<div class="col">
																<label for="recipient-name" class="col-form-label">Giảm 
																	:</label> <label for="recipient-name" class="col-form-label">
																	${dotkhuyenmai.phanTramGiam} %</label>
															</div>
														</div>
