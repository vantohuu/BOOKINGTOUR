		...
		<div class="row flex-nowrap">
			...
			<div class="col py-3">
					...
					<div class="alert alert-success fade show" role="alert"style='position: fixed; width:50%; margin-left:300px; z-index: 100 '>
						...
						<p>Cập nhật địa điểm thành công</p>
						<hr>
					</div>
				</c:if>
				<c:if test="${message==2}">
				...
				<div class="container form-dang-nhap">
					<div class="modal-body">
						<form:form action="update.htm" modelAttribute="diemDuLich1">
							<div class="form-group">
							<div>
									<h1>Sửa thông tin địa điểm du lịch</h1>
								</div>
								<div class="row">
									<div class="col">
										<label for="recipient-name" class="col-form-label">ID :</label> 
											<form:input path="id" type="text" class="form-control"  readonly="true" value="${diemDuLich.id}"/>
								...
								<div class="row">
									<div class="col">
										<label for="recipient-name" class="col-form-label">Tên điểm :</label> 
											<form:input path="ten" type="text" class="form-control"  value="${diemDuLich.ten}"/>
									...
									<div class="col">
										<label for="recipient-name" class="col-form-label">Địa chỉ :</label> 
											<form:input path="diaChi" type="text" class="form-control"  value="${diemDuLich.diaChi}" />
